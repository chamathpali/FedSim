...
with open('flearn/models/goodreads/embs.json', 'r') as inf:
    embs = json.load(inf)
id2word = embs['vocab']
...
def process_x(raw_x_batch, max_words=40):
    x_batch = [e for e in raw_x_batch]
...
def process_y(raw_y_batch):
    y_batch = [1 if e == 1 else 0 for e in raw_y_batch]
...
class Model(object):
    ...
    def create_model(self, optimizer):
        ...
        optimizer = tf.train.AdamOptimizer(learning_rate=0.0001) #comment this for FedProx
